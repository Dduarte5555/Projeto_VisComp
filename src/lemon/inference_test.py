from Inference import load_and_run_inference_2_5D, evaluate_folder, load_and_run_inference_2D
from Inference3d import run_3d_inference

if __name__ == "__main__":
    model2d   = "models/best_model2D_64x64_side_view.pth"
    model2_5d = "models/best_model2_5D_64x64x3.pth"
    model3d   = "models/best_model3d_64x64x64.keras"
